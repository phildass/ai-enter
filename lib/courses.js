...
export const IG_DISCOUNT_PRICE_BREAKDOWN =
  '(₹99 + 18% GST) — Instagram follower membership · 13 months · no 1+1';
export const IG_DISCOUNT_VALIDITY_TEXT = '13 Months';
export const IG_DISCOUNT_TAGLINE =
  'Instagram follower membership — Rs 116.82 (incl. GST) — Validity 13 months — no 1+1';
export const IG_DISCOUNT_LIMITED_TIME_NOTICE =
  'Follow @philintheblank100 must be verified within 24 hours of payment or membership is cancelled with no refund. One use per AppMall account.';
