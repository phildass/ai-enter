...
export const courses = [
  ...
  },
  {
    ...
    description: 'Complete bundle: Master both AI and software development skills',
    features: [
      'All Learn AI course content',
      'All Learn Developer course content',
      'Integrated projects combining AI and development',
      'Special combo pricing - same as Learn AI!'
    ],
    isCombo: true,
    comboPrice: true // Same price as Learn AI
  }
];
