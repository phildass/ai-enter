...
export const courses = [
  ...
  // Paid Courses (4)
  {
    ...
    isPaid: true,
    price: 99, // Base price before GST
    features: [
  ...
  },
  {
    ...
    isCombo: true,
    comboPrice: true,
    price: 99, // Same price as single course - special combo pricing
    features: [
...
// Paid courses available for purchase on the iiskills payment page
// Includes individual courses AND bundle aliases
export const IISKILLS_ALLOWED_COURSES = [
  // Individual paid apps
  'learn-ai',
  'learn-developer',
  'learn-pr',
  'learn-management',
  // Bundle aliases (promotional bundles from iiskills)
  'launch_5_in_1',
  'LAUNCH_5_IN_1_2026',
  'mega_4_in_1',
  'MEGA_4_IN_1_2026',
...
// Default amount for iiskills courses: ₹99 + 18% GST = ₹116.82 → 11682 paise
