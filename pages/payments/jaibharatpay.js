...
export default function JaiBharatPay() {
    ...
    try {
      ...
      script.onload = () => {
        const options = {
          ...
          name: 'Jai Bharat',
          description: 'Lifetime Access - Government Jobs',
          ...
          handler: async function (response) {
            ...
            if (verifyData.success) {
              router.push('/payments/success?app=jai-bharat');
            } else {
    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#eef2ff' }}>
        <div style={{ background: 'white', borderRadius: '16px', padding: '2rem', textAlign: 'center', boxShadow: '0 10px 40px rgba(0,0,0,0.08)' }}>
          <p style={{ color: '#ef4444', marginBottom: '1rem' }}>Invalid payment link. Please open from the Jai Bharat app.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <>
      <Head>
        <title>Jai Bharat Payment - ₹116.82</title>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
            ...
            <h1 style={{ fontSize: '1.8rem', fontWeight: '700', color: '#1e1b4b', marginBottom: '0.25rem' }}>
              Jai Bharat
            </h1>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', fontSize: '0.85rem' }}>
              {['Access to all govt. job prep', 'SSC, Banking, Railways, IAS', 'Mock tests & career ladder', 'No recurring fees'].map((feature) => (
